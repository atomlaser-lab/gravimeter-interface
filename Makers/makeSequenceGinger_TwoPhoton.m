function varargout = makeSequenceGinger_TwoPhoton(varargin)
...
if(VMG_Run)
    ...
    raman_delay_drop = 8e-3; %5e-3 %10.8e-3
    interrogation_time = 0; %6e-3
    Traman_pi = 20e-6; %18e-6
    F2_tof = 10e-3; %7e-3 %20.1e-3 %11e-3
    ...
    Power_raman_LG = 0.6; %1 %carrier
    Delta_raman = opt.param; %20.02 + 1.967155096615827e-2
