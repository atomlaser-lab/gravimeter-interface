function sq = initSequence
    ...
    sq.analog(6).setName('2DMOT Freq','AO/5','')...
        .setConversionFunction(@(x) FtoV('2d',x),'MHz').setDefault(8);
    sq.analog(7).setName('Raycus CW','AO/6','14 W/3.5 V MAXIMUM')...
        .setConversionFunction(@(x) DipolePtoV('raycus',x),'W').setDefault(0).setBounds([0,14]);
    sq.analog(8).setName('Push Freq','AO/7')...
        .setConversionFunction(@(x) FtoV('push',x),'MHz').setDefault(10);
    sq.analog(9).setName('RedPower CW','B0/0')...
        .setConversionFunction(@(x) DipolePtoV('redpower',x),'W').setDefault(0).setBounds([0,20]);
    ...
    sq.analog(12).setName('MOT bias coil','BO/3')...
        .setConversionFunction(@(x) x/0.1753,'G').setDefault(0);
    sq.analog(13).setName('87 imag amp','BO/4')...
        .setConversionFunction(@(x) TrapPtoV('image',x),'').setDefault(0.5);
    ...
    sq.analog(20).setName('CD0 Fast','CO/3')...
        .setConversionFunction(@(x) dBtoV('normal',x),'G/cm').setDefault(14);
